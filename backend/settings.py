...
import os
from decouple import config# Build paths inside the project like this: BASE_DIR / 'subdir'.
...
# STATICFILES_DIRS = os.path(BASE_DIR,  'build', 'static'),
